...
public class TargetBlock {
    ...
    private void setValues(Location loc, int maxDistance, double viewHeight, double checkDistance, int[] blocksToIgnore)
    {
        ...
        targetPos = new Vector((int)Math.floor(loc.getX()), (int)Math.floor(loc.getY() + viewHeight), (int)Math.floor(loc.getZ()));
    ...
    public void reset()
    {
    	targetPos = new Vector((int)Math.floor(this.loc.getX()), (int)Math.floor(this.loc.getY() + viewHeight), (int)Math.floor(this.loc.getZ()));
        prevPos = targetPos.clone();
    	this.curDistance = 0;
    }
    ...
    public Block getNextBlock()
    {
        ...
        do
        {
            ...
            targetPos.setY((int) Math.floor(offset.getY() + loc.getY() + viewHeight));
